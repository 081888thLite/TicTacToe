...
var _user$project$Views$game_play_screen = A2(
						...
						_1: {
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Prompt player for move.'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
...
var _user$project$Views$welcome_screen = function (actionOnClick) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(_user$project$Views$welcome_view_greeting),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(_user$project$Views$welcome_view_prompt),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('w3-display-bottommiddle w3-jumbo w3-btn w3-ripple w3-orange'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(actionOnClick),
								_1: {ctor: '[]'}
							}
						},
						{
...
var _user$project$GameLoop$playScreen = function (players) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Views$game_play_screen,
			_1: {ctor: '[]'}
		});
};
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"GameLoop.Msg":{"args":[],"tags":{"BeginPlay":[],"SetMode":[],"SetPlayersCvC":[],"SetPlayersHvH":[],"SetPlayersHvC":[]}}},"aliases":{},"message":"GameLoop.Msg"},"versions":{"elm":"0.18.0"}});
}
